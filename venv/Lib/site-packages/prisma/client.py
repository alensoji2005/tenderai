...
SCHEMA_PATH = Path('D:/projects/tenderai-oman/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\alens\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    tender: 'actions.TenderActions[models.Tender]'
    boqitem: 'actions.BOQItemActions[models.BOQItem]'
    ...
    def __init__(
        ...
        *,
        ...
        self.tender = actions.TenderActions[models.Tender](self, models.Tender)
        self.boqitem = actions.BOQItemActions[models.BOQItem](self, models.BOQItem)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'D:/projects/tenderai-oman/prisma/schema.prisma',
        }
...
class Batch:
    ...
    tender: 'TenderBatchActions'
    boqitem: 'BOQItemBatchActions'
    bid: 'BidBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.tender = TenderBatchActions(self)
        self.boqitem = BOQItemBatchActions(self)
